...
int main(void)
{
    ...
    //Se configura la velocidad del reloj
    Configura_Reg_ADC0();
    Configurar_UART1();
    ...
    while(1)
    {
         ...
         //uso del utoa, que transforma de un unsigned integer a string
         ...
         vdig[3]= ADC0->SSFIFO2& 0xFFF0;
                                    ...
                                    /* Enable SS3 conversion or start sampling data from AN0 */
            /* Wait untill sample conversion completed*/
         vdig[4]= ADC0->SSFIFO2& 0xFF0F;
            /* Wait untill sample conversion completed*/
         
         vdig[5]= ADC0->SSFIFO2& 0xFFFF;
